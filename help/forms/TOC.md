...
+ 自适应表单 {#adaptive-forms}
   ...
   + [AEM Forms中的用户用户档案数据集成](adaptive-forms/user-profile-data-integration-feature-video-use.md)
   ...
   + [将项目动态添加到Choice组件](adaptive-forms/choice-group-items-adding-dynamically-article.md)
+ 使用表单数据模型{#prefill-fdm-db}预填自适应表单
...
+ AEM Forms和Adobe Sign{#forms-and-sign}
   ...
   + [将XDP模板与Adobe Sign结合使用](aem-forms-and-adobe-sign/using-xdp-templates-with-adobe-sign.md)
+ 对多个Forms进行签名{#sign-multiple-documents}
...
+ 查询已提交的数据{#querying-submitted-data}
   ...
   + [创建基于JSON的表单模式](querying-submitted-data/part1.md)
...
+ 列出Forms Portal中的自定义资产类型{#listing-custom-asset-types}
   + [Part1 — 注册自定义资产类型](listing-custom-asset-types/part1.md)
   + [第2部分 — 创建自定义模板](listing-custom-asset-types/part2.md)
+ AEM Forms与Marketo{#aem-forms-with-marketo}
   + [第1部分 — 导言](aem-forms-with-marketo/part1.md)
   + [第2部分 — 自定义身份验证](aem-forms-with-marketo/part2.md)
   + [第3部分 — 数据源](aem-forms-with-marketo/part3.md)
   + [第4部分 — 将所有内容组合在一起](aem-forms-with-marketo/part4.md)

+ AEM Forms wAdobe Campaign Standard{#aem-forms-with-adobe-campaign}
   ...
   + [第2部分 — 在表单提交时创建ACS用户档案](aem-forms-with-adobe-campaign/parttwo.md)
   + [第3部分 — 使用ACS用户档案信息预填表单](aem-forms-with-adobe-campaign/partthree.md)
   + [第4部分 — 使用表单用户档案模型创建ACS](aem-forms-with-adobe-campaign/partfour.md)
...
+ 文档服务 {#document-services}
   ...
   + [验证文档](document-services/certifying-documents-aem-forms-tutorial.md)
   + [组合表单附件](document-services/assemble-form-attachments.md)
   + [有用的实用服务](document-services/useful-utility-services.md)
+ 交互式通信以实现印刷渠道
...
+ 交互式通信 {#interactive-communications}
   ...
   + [从提交的数据生成打印渠道文档](interactive-communications/merge-data-with-ic-template.md)
...
+ 用于Web渠道的交互式通信{#ic-web-channel-tutorial}
   ...
   + [电子邮件投放Web渠道文档](interactive-communications/delivery-of-web-channel-document-tutorial-use.md)
