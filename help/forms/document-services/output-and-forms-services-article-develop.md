---
title: 在AEM Forms中使用Output和Forms服务进行开发
...
# 在AEM Forms中使用Output和Forms服务进行开发{#developing-with-output-and-forms-services-in-aem-forms}
...
该软件包包含3个示例。 以下段落说明了何时使用输出服务或Forms服务、服务的URL以及每个服务期望的输入参数
...
* **请求参数 —**
   ...
   * **saveLocation**：将渲染的文档保存在文件系统中的位置。 例如c：\\documents\\sample.pdf
...
* **请求参数：**
   ...
   * **saveLocation**：将渲染的文档保存在文件系统中的位置。 例如 `c:\\outputsample.pdf`。
