...
此外，还建议参阅[文章](https://docs.adobe.com/content/help/en/experience-manager-learn/forms/document-services/generate-pdf-from-mobile-form-submission-article.html)，介绍如何通过HTML5表单提交生成PDF。
