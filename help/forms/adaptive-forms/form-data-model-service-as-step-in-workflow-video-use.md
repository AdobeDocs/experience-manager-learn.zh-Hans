...
>[!VIDEO](https://video.tv.adobe.com/v/330120?captions=chi_hans&quality=12&learn=on)
...
* [下载并部署setvalue包](/help/forms/assets/common-osgi-bundles/SetValueApp.core-1.0-SNAPSHOT.jar)。 这是用于设置元数据属性的自定义OSGI捆绑包。
  ...
  >[!NOTE]
  >
  >在AEM Forms 6.5及更高版本中，此功能现成可用，如此处[所述](form-data-model-service-as-step-in-aem65-workflow-video-use.md)
