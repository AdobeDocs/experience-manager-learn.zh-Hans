...
* 场景1 ：使用AEM Experience Fragments的Personalization
* 场景2 ：使用可视化体验编辑器的Personalization
* 场景3 ：完整网页体验的Personalization

## 使用AEM Experience Fragments的Personalization {#personalization-using-aem-experience-fragment}

对于这种情况，我们将使用AEM和Target。 很显然，这两种产品都有各自的优势，并且在为网站用户提供个性化体验方面，您需要&#x200B;**个性化内容(AEM的内容)**&#x200B;和&#x200B;**智能方式(Target)**&#x200B;来根据特定用户提供这些内容。
...
**体验片段**&#x200B;代表了在将内容/体验创建者与使用Target推动业务结果的个性化专业人员关联方面迈出了巨大的一步。
...
* Target提供体验片段HTML，AEM提供引用的图像
  ...
  ![使用体验片段图的Personalization](assets/personalization-use-case-1/use-case-1-diagram.png)
...
***实施上述集成后，让我们详细了解[方案](./personalization-use-case-1.md)。***
...
* 适用于AEM托管站点和非AEM托管站点
  ...
  ![使用可视化体验编辑器图表的Personalization](assets/personalization-use-case-3/use-case-diagram-3.png)

**要实施此方案，您需要：**

* [使用标记和Adobe I/O集成AEM和Adobe Target](./implementation.md#integrating-aem-target-options)

***实施上述集成后，让我们详细了解[方案。](./personalization-use-case-3.md)***

## 完整网页体验的Personalization
...
* 适用于AEM和非AEM站点
  ...
  ![关系图](assets/personalization-use-case-2/use-case-2-diagram.png)

**要实施此方案，您需要：**

* [使用标记和Adobe I/O集成AEM和Adobe Target](./implementation.md#integrating-aem-target-options)

***实施上述集成后，让我们详细了解[方案。](./personalization-use-case-2.md)***
