...
场文件具有基于场[的](https://experienceleague.adobe.com/docs/experience-manager-dispatcher/using/configuring/dispatcher-configuration.html?lang=zh-Hans#defining-farms-farms)顶级部分的子包含，如缓存、clientheaders、筛选器、渲染器和主机。
