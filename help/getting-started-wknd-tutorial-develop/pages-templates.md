...
1. 在&#x200B;**Breadcrumb**&#x200B;组件下方和&#x200B;**main**&#x200B;容器中添加&#x200B;**容器**&#x200B;组件。 这将充当模板的&#x200B;**内容容器**。
   * 解锁&#x200B;**内容**&#x200B;容器。
   * 将策略设置为&#x200B;**页面内容**。
1. 在&#x200B;**内容容器**&#x200B;下添加另一个&#x200B;**容器**&#x200B;组件。 这将充当模板的&#x200B;**侧边栏**&#x200B;容器。
   * 解锁&#x200B;**侧边栏**&#x200B;容器。
   * 创建名为&#x200B;**文章页——侧边栏**&#x200B;的新策略。
   * 将&#x200B;**WKND Sites Project - Content**&#x200B;下的&#x200B;**允许的组件**&#x200B;配置为包括：**按钮**、**下载**、**图像**、**列表**、**分隔符**、**共享**&#x200B;的社交媒体，**文本**&#x200B;和&#x200B;**标题**。
...
1. 打开移动模拟器并切换到移动断点。 再次启用布局模式，使&#x200B;**内容容器**&#x200B;和&#x200B;**侧边栏容器**&#x200B;成为页面的完整宽度。 这将在移动断点中垂直堆栈容器。
1. 更新&#x200B;**内容容器**&#x200B;中&#x200B;**Text**&#x200B;组件的策略。
   * 将策略设置为&#x200B;**内容文本**。
   * 在&#x200B;**插件** > **段落样式**&#x200B;下，选中&#x200B;**启用段落样式**&#x200B;并确保启用&#x200B;**引号块**。
...
1. 将&#x200B;**标题**&#x200B;组件添加到&#x200B;**侧边栏容器**。
   * 使用文本配置组件：“分享此故事”。
   * 将类型设置为`H5`。
1. 在&#x200B;**共享此Story**&#x200B;标题组件下添加&#x200B;**社交媒体共享**&#x200B;组件。
1. 在&#x200B;**社交媒体共享**&#x200B;组件下添加&#x200B;**分隔符**&#x200B;组件。
1. 在&#x200B;**Separator**&#x200B;组件下添加&#x200B;**下载**&#x200B;组件。
1. 在&#x200B;**下载**&#x200B;组件下添加&#x200B;**列表**&#x200B;组件。
1. 更新模板的&#x200B;**初始页面属性**。
...
1. 视图模板控制台中的模板，方法是导航到[http://localhost:4502/libs/wcm/core/content/sites/templates.html/conf/wknd](http://localhost:4502/libs/wcm/core/content/sites/templates.html/conf/wknd)
1. **启** 用文章页面模板。
1. 编辑文章页面模板的属性并上传以下缩略图以快速识别使用文章页面模板创建的页面：
...
1. 使用位于[http://localhost:4502/crx/packmgr/index.jsp](http://localhost:4502/crx/packmgr/index.jsp)的包管理器上传和安装内容包
...
1. 配置片段的根&#x200B;**容器**。 这是最外部&#x200B;**容器**。
   * 将&#x200B;**布局**&#x200B;设置为&#x200B;**响应式网格**
1. 将&#x200B;**WKND Dark徽标**&#x200B;添加为图像到&#x200B;**容器**&#x200B;的顶部。 徽标包含在上一步安装的包中。
   * 将&#x200B;**WKND暗标志**&#x200B;的布局修改为&#x200B;**2**&#x200B;列宽。 从右向左拖动手柄。
...
1. 配置片段的根&#x200B;**容器**。 这是最外部&#x200B;**容器**。
   * 将&#x200B;**布局**&#x200B;设置为&#x200B;**响应式网格**
1. 将&#x200B;**WKND Light徽标**&#x200B;添加为图像到&#x200B;**容器**&#x200B;的顶部。 徽标包含在上一步安装的包中。
...
1. 在&#x200B;**WKND** > **US** > **EN** > **Magazine**&#x200B;下创建新页面。
   * 选择&#x200B;**文章页面**&#x200B;模板。
   * 在&#x200B;**属性**&#x200B;下，将&#x200B;**标题**&#x200B;设置为“LA Skateparks的终极指南”
   * 将&#x200B;**名称**&#x200B;设置为“guide-la-skateparks”
1. 将&#x200B;**By Author** Title替换为文本“By Stacey Roswells”。
1. 更新&#x200B;**Text**&#x200B;组件以包含用于填充文章的段落。 可以使用以下文本文件作为副本：[la-skate-parks-copy.txt](assets/pages-templates/la-skateparks-copy.txt)。
1. 添加另一个&#x200B;**Text**&#x200B;组件。
   * 更新组件以包含报价：“没有比洛杉矶更好的去处了。”
