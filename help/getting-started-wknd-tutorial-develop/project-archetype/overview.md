...
此教程设计为与&#x200B;**AEM as a Cloud Service**&#x200B;配合使用，并且向后兼容&#x200B;**AEM 6.5.14+**。 站点会通过以下项目实施：
...
需要本地开发环境来完成本教程。 使用在将[Visual Studio Code](https://code.visualstudio.com/)作为IDE的macOS环境中运行的AEM as a Cloud Service SDK捕获屏幕截图和视频。 除非另有说明，否则命令和代码应独立于本地操作系统。

### 所需的软件

下列内容应本地安装：

* [本地AEM **创作**&#x200B;实例](https://experience.adobe.com/#/downloads)(Cloud ServiceSDK或6.5.14+)
...
你在等什么？ 导航到[项目设置](project-setup.md)章以启动该教程，并了解如何使用AEM项目原型生成新的Adobe Experience Manager项目。
