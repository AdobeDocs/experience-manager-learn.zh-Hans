...
+ 人工智能 {#ai}
   ...
   + [设置和配置](./ai/setup.md)
   + AI 助手 {#ai-assistant}
      + [概述](./ai/ai-assistant/overview.md)
      + [什么是AI助手？](./ai/ai-assistant/what-is-ai-assistant.md)
      + [谁的AI助手？](./ai/ai-assistant/who-is-ai-assistant-for.md)
      + [主要功能](./ai/ai-assistant/key-capabilities.md)
      + [AI助理和Agentic AI](./ai/ai-assistant/ai-assistant-and-agentic-ai.md)
   + 代理 {#agents}
      + [概述](./ai/agents/agents-in-aem.md)
      + [开发代理和CI/CD故障排除](./ai/agents/development-agent-troubleshoot-ci-cd-pipeline.md)
   + MCP服务器 {#mcp-servers}
      + [概述](./ai/mcp/overview.md)
      + [使用MCP服务器加速AEM内容操作](./ai/mcp/accelerate-content-operations-with-aem-mcp-server.md)
      + [Cloud Manager MCP服务器](./ai/mcp/cloud-manager.md)
   + AI辅助开发 {#ai-assisted-development}
      + [概述](./ai/ai-assited-development/overview.md)
      + 设置{#setup}
         + [座席技能](./ai/ai-assited-development/setup/agent-skills.md)
      + 用例{#use-cases}
         + [组件开发](./ai/ai-assited-development/use-cases/component-development.md)
...
+ 身份验证{#authentication}
   ...
   + [SAML登录挂钩](./authentication/saml-2-0-login-hook.md)
+ 高级网络{#networking}
...
+ Forms{#forms}
   ...
   + 在AEP中创建表单提交配置文件{#aep-integration}
      + [简介](./forms/aep-integration/introduction.md)
      + [创建云配置](./forms/aep-integration/create-cloud-configuration.md)
      + [配置表单以提交AEP](./forms/aep-integration/create-integration-with-aep.md)
...
+ 多步教程{#multi-step-tutorials}
   + [AEM Sites开发](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/overview.html){target=_blank}
