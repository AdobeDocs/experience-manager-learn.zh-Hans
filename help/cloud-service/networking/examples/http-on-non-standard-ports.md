---
title: 非标准端口上的HTTP/HTTPS连接，用于专用出口IP地址和VPN
description: 了解如何使从AEM到外部Web服务的HTTP/HTTPS请求as a Cloud Service，这些服务在专用出口IP地址和VPN的非标准端口上运行
...
# 非标准端口上的HTTP/HTTPS连接，用于专用出口IP地址和VPN
