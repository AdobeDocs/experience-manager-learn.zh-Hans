...
description: 以下视频概述了使用AEM创作环境时的基本处理。 它使用 Sites 控制台作为基础。
...
以下视频概述了使用AEM创作环境时的基本处理。 它使用 Sites 控制台作为基础。

>[!VIDEO](https://video.tv.adobe.com/v/37000?captions=chi_hans&quality=12&learn=on)
...
* “全局导航”面板包括：
   * 导航 — 登录到AEM时由一个指南针图标
     ...
     | 控制台 | 用途 |
     |---|---|
     | Assets | 通过这些控制台，您可以导入和管理数字资产，如图像、视频、文档和音频文件。 随后，这些资源便可由同一AEM实例上运行的任何网站使用 |
     | Communities | 利用此控制台，可创建和管理社区站点以供参与和启用 |
     | Commerce | 这允许您管理与您的Commerce网站相关的产品、产品目录和订单 |
