...
description: 了解开发在AEM通用编辑器中创作并使用Edge Delivery Services交付的新网站的基础知识。
...
![Edge Delivery Services和Universal Editor开发人员教程](./assets/0-overview/hero.png)

在本教程中，您将学习构建一个AEM网站的基础知识，该网站将强大的创作与通用编辑器结合使用，并使用Edge Delivery Services进行超快交付。 到最后，您将基本了解如何创建新项目、设置本地开发环境和构建新块。
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">为Edge Delivery Services创建一个代码项目，该代码项目可以使用通用编辑器进行编辑。</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">在AEM Sites中为Edge Delivery Services创建一个站点，该站点可使用通用编辑器进行编辑。</p>
                </div>
...
了解如何配置本地开发环境以实现快速网站开发。 这种设置允许使用通用编辑器无缝创建站点，并通过Edge Delivery Services高效地交付内容，从而确保流畅且优化的开发工作流。
<!-- CARDS 
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./3-local-development-environment.md" title="设置本地开发环境" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3443988/?format=jpeg&nocache=1741027443737&captions=chi_hans" alt="设置本地开发环境"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
...
了解如何通过定义内容模型并设置用于测试和开发的示例内容来创建新块。 探索两种呈现块的方法，并了解如何在AEM和Edge Delivery Services中构建块以优化性能和灵活性。
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">使用Edge Delivery Services的CSS开发块，该块可使用通用编辑器进行编辑。</p>
                </div>
...
现在，您已完成本教程，请继续学习这些重点操作说明。 这些指南扩展了此处涵盖的代码和概念，探索特定于角色的用例、高级技术和其他提示以增强Edge Delivery Services和通用编辑器的开发技能。
...
<div class="columns">
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Block options">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./how-to/block-options.md" title="块选项" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="how-to/assets/block-options/main.png" alt="块选项"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./how-to/block-options.md" target="_blank" rel="referrer" title="块选项">阻止选项</a>
                    </p>
                    <p class="is-size-6">了解如何使用多个显示选项构建块。</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">了解如何在Edge Delivery Services和通用编辑器中使用页眉和页脚。</p>
                </div>
