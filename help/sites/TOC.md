...
+ 页面创作 {#page-authoring}
   ...
   + [页面版本](page-authoring/page-versioning-feature-video-use.md)
...
+ 开发 {#developing}
   ...
   + [用样式体系进行开发](developing/style-system-technical-video-understand.md)
   + [样式系统最佳实践](developing/style-organization-style-system-understand-article.md)
   + [为页面差异开发](developing/page-diff-technical-video-develop.md)
...
+ 单页应用程序 {#spa-editor}
   + [使用SPA Editor](spa-editor/spa-editor-framework-feature-video-use.md)
...
+ 集成 {#integrations}
   ...
   + Adobe Target {#target}
      ...
      + [将目标扩展添加到启动项属性](integrations/adobe-target/add-target-launch-extension.md)
      + [加载和触发目标呼叫](integrations/adobe-target/load-and-fire-target.md)
      ...
      + [使用Visual Experience Composer实现个性化](integrations/adobe-target/personalization-using-vec.md)
      + [个性化完整网页体验](integrations/adobe-target/personalization-web-page.md)
