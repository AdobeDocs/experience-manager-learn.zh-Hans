---
title: 将图像锐化与AEM Dynamic Media结合使用
seo-title: 将图像锐化与AEM Dynamic Media结合使用
description: 此视频介绍锐化图像对保持图像保真度至关重要的原因，以及如何使用高级设置制作完美图像。
seo-description: 此视频介绍锐化图像对保持图像保真度至关重要的原因，以及如何使用高级设置制作完美图像。
