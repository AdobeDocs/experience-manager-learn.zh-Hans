...
>[!NOTE]
>
> 我们建议您在2020年10月1日之前安装新的Adobe Dynamic Media Classic桌面应用程序。 这样做可确保在2020年12月31日弃用AdobeFlash Player之前实现顺利过渡。 在该日期，您将无法再登录到浏览器版本的Adobe Dynamic Media Classic用户界面，该用户界面在产品中标记为Scene7发布系统。
