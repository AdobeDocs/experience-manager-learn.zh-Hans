...
+ 协作{#collaboration}
   ...
   + [登记和注销](./collaboration/check-in-and-check-out.md)
...
+ 共享和分发{#sharing}
   ...
   + 资产共享{#assets-share}
      + [资产共享共享共享](./sharing/asset-share-commons-user-experience-feature-video-understand.md)
...
+ Adobe Asset Link{#adobe-asset-link}
   ...
   + [版本和注释](./adobe-asset-link/file-versioning-and-comments.md)
   + [置入副本](./adobe-asset-link/place-copy.md)
   + [链接的位置](./adobe-asset-link/place-linked.md)
