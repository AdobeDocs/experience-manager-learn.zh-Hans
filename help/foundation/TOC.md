...
+ 开发 {#development}
   ...
   + [设置Sling Dynamic Include](./development/set-up-sling-dynamic-include.md)
   + [了解Java API最佳实践](./development/understand-java-api-best-practices.md)
   + [了解Sling Model Exporter](./development/understand-sling-model-exporter.md)
+ 项目 {#projects}
...
+ 安全 {#security}
   ...
   + [为跨来源资源共享(CORS)进行开发](./security/develop-for-cross-origin-resource-sharing.md)
   + [了解跨来源资源共享(CORS)](./security/understand-cross-origin-resource-sharing.md)
