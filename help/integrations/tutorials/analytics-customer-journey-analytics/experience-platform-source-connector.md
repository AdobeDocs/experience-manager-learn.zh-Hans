---
title: 将Analytics和Customer Journey Analytics与Experience Platform源连接器集成教程
description: 了解如何将Adobe Analytics与Customer Journey Analytics集成。
...
# 将Adobe Analytics和Customer Journey Analytics与Experience Platform源连接器集成
...
<ol>
    ...
    <li><i>(可选)</i>. 如果使用多个数据集，请将人员ID拼合到 <a href="https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/combined-dataset.html" _target="_blank" rel="noopener noreferrer">生成组合数据集</a>. 如果使用单个Analytics数据集，或者如果您计划在Customer Journey Analytics中使用的所有数据集都存在通用标识符，请跳过此步骤。</li>
    <li><a href="https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/connections/connecting-customer-journey-analytics-to-data-sources-in-platform.html" _target="_blank" rel="noopener noreferrer">创建连接</a> 在Customer Journey Analytics中。</li>
    ...
    <li><a href="https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/workspace-projects/build-a-new-project.html" _target="_blank" rel="noopener noreferrer">在Customer Journey Analytics中创建项目。</a></li>
</ol>
